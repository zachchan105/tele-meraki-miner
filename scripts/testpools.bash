...
#
# Testscript to test telemerakiminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of telemerakiminer and start running
#
...
# export some vars as "./telemerakiminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./telemerakiminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./telemerakiminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./telemerakiminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
